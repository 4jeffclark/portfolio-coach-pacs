...
- `Metrics.csv` — rebuild and validation summary, including `portfolioSymbolCountBefore`, `portfolioSymbolCountAfter`, `portfolioSymbolCountDelta`, `positionRowsBefore`, `positionRowsAfter` when rebuild runs
